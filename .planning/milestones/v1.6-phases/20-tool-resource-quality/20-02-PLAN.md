...
**update_session:**
- Ownership fail (`verifySessionOwnership` returns `!owned`): `toolError('access_denied', 'Access denied to session {session_id}. You can only modify sessions belonging to your clients.')`
- DB error on update: `toolError('database_error', 'Failed to update session: {error.message}')`

**delete_session:**
- Ownership fail (`verifySessionOwnership` returns `!owned`): `toolError('access_denied', 'Access denied to session {session_id}. You can only modify sessions belonging to your clients.')`
- DB error on delete: `toolError('database_error', 'Failed to delete session: {error.message}')`

**complete_session:**
- Ownership fail (`verifySessionOwnership` returns `!owned`): `toolError('access_denied', 'Access denied to session {session_id}. You can only modify sessions belonging to your clients.')`
- DB error on update: `toolError('database_error', 'Failed to complete session: {error.message}')`

**duplicate_session:**
- Source session ownership fail (`verifySessionOwnership` returns `!owned`): `toolError('access_denied', 'Access denied to session {session_id}. You can only modify sessions belonging to your clients.')`
- Target client ownership fail (`verifyClientOwnership` returns `!owned`): `toolError('access_denied', 'Access denied to client {new_client_id}. You can only create sessions for your own clients.')`
- Fetch original fail (DB query returns no rows after ownership passes): `toolError('not_found', 'Session {session_id} not found.')`
- Create new fail: `toolError('database_error', 'Failed to duplicate session: {error.message}')`

**add_session_exercise:**
- Ownership fail (`verifySessionOwnership` returns `!owned`): `toolError('access_denied', 'Access denied to session {session_id}. You can only modify sessions belonging to your clients.')`
- DB error on insert: `toolError('database_error', 'Failed to add exercise: {error.message}')`

**update_session_exercise:**
- Ownership fail (`verifySessionExerciseOwnership` returns `!owned`): `toolError('access_denied', 'Access denied to session exercise {session_exercise_id}. You can only modify exercises in your clients\' sessions.')`
- DB error on update: `toolError('database_error', 'Failed to update exercise: {error.message}')`

**remove_session_exercise:**
- Ownership fail (`verifySessionExerciseOwnership` returns `!owned`): `toolError('access_denied', 'Access denied to session exercise {session_exercise_id}. You can only modify exercises in your clients\' sessions.')`
- DB error on delete: `toolError('database_error', 'Failed to remove exercise: {error.message}')`
